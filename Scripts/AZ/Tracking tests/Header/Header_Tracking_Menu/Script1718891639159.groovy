...
assert event != null : 'L\'événement de tracking "menu" avec "menu" n\'a pas été trouvé dans la couche de données.'

assert event.event_name == 'menu' : 'L\'événement trouvé n\'est pas "menu".'

println('L\'événement de tracking \'menu\' avec \'menu\' a été trouvé avec succès dans la couche de données.')
