...
WebUI.click(findTestObject('AZ/Pages/Header_and_Footer/Header/Navigation banner_5'))
...
WebUI.click(findTestObject('AZ/Pages/PLP/a_PLP_CompositionsForBroadcast'))
