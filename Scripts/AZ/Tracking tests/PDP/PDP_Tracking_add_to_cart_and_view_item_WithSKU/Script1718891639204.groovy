...
assert event4 != null : 'L\'événement de tracking \'view_item\' avec \'view_item\' et event.ecommerce.items.0.item_sku === \'04028\' n\'a pas été trouvé dans la couche de données.'

assert event4.event_name == 'view_item' : 'L\'événement trouvé n\'est pas \'view_item\'.'

println('L\'événement de tracking \'view_item\' avec \'view_item\' et event.ecommerce.items.0.item_sku === \'04028\' a été trouvé avec succès dans la couche de données.')
