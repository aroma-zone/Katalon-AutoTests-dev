...
WebUI.setText(findTestObject('AZ/Components/Search bar/input_search titem'), 'cuticules')
...
WebUI.verifyTextPresent('Vous avez cherché : "cuticules "', false)
