...
assert event != null : 'L\'événement de tracking "view_item" avec "view_item" n\'a pas été trouvé dans la couche de données.'

assert event.event_name == 'view_item' : 'L\'événement trouvé n\'est pas "view_item".'

println('L\'événement de tracking \'view_item\' avec \'view_item\' a été trouvé avec succès dans la couche de données.')
