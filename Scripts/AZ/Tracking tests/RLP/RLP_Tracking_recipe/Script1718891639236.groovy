...
WebUI.click(findTestObject('AZ/Pages/Header_and_Footer/Header/Navigation banner_Recettes'))
...
assert event != null : 'L\'événement de tracking "recipe" avec "generic_event" n\'a pas été trouvé dans la couche de données.'

assert event.event_name == 'generic_event' : 'L\'événement trouvé n\'est pas "generic_event".'

assert event.event == 'generic_event' : 'L\'événement trouvé n\'est pas "generic_event".'
