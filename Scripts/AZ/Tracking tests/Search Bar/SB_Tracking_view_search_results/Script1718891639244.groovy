...
assert event != null : 'L\'événement de tracking "generic_event" avec "search" n\'a pas été trouvé dans la couche de données.'

assert event.event_name == 'generic_event' : 'L\'événement trouvé n\'est pas "generic_event".'

println('L\'événement de tracking \'generic_event\' avec \'search\' a été trouvé avec succès dans la couche de données.')
