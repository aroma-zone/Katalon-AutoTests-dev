...
WebUI.click(findTestObject('AZ/Pages/MyAccountPage/a_mywishlist'))

WebUI.verifyTextPresent('Mes favoris', false)

WebUI.verifyTextPresent('Vous n’avez pas encore de produits favoris', false)
