...
File file2 = new File("C:\\LINKS SEO FR IT\\verified_links_header_IT.txt")
...
KeywordUtil.logInfo("Vérification des liens terminée. Résultats dans 'verified_links_HP_IT.txt'")
