...
String stageURLcanonical = GlobalVariable.SEO_Canonical_PDP_IT

String stageURL = GlobalVariable.SEO_PDP_IT
...
List<String> ssrModules = ['Olio essenziale di Achillea millefoglie BIO', 'Precauzioni', 'Tracciabilità e analisi', 'Caratteristiche'
    , 'Prodotti associati']
