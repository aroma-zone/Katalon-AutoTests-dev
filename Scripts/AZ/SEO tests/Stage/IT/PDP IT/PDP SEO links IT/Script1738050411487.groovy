...
String authenticatedURL = "https://aroma-zone:avant-premiere@stage.aroma-host.net/it/product/olio-essenziale-achillea-millefoglie-bio"
...
Element mainContent = document.selectFirst("body > div:not(div#menu.menu):not(#__layout > div > div:nth-child(6)):not(nav)")
...
File file2 = new File("C:\\LINKS SEO FR IT\\verified_links_PDP_IT.txt")
